...
namespace BoxOfYellow.ConsoleMarkdownRenderer.ObjectRenderers
{
    internal abstract partial class ConsoleRendererBase : RendererBase
    {
        ...
        /// <see cref="ConsoleEmphasisInlineRenderer"/>. Populated regardless
        /// of <see cref="SpectreDisplayOptions.IncludeDebug"/>.
        /// </summary>
        ...
        /// Called by <see cref="ConsoleEmphasisInlineRenderer"/>.
        /// </summary>
        ...
        /// with a <see cref="SpectreFigletHeaderStyle"/>) that need to emit a Spectre.Console
