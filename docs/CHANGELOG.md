...
- [#320](https://github.com/boxofyellow/ConsoleMarkdownRenderer/pull/320): Add convention tests that reject Markdig line backing-array capacity reads and enforce derived Markdown renderer registration before their handled base types.
